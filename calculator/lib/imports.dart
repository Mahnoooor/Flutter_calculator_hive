...
AppBar appbar(
  ...
  return AppBar(
    // backgroundColor: Color.fromARGB(131, 158, 158, 158), // set the background color to blue
    title: Text(
      title,
    ...
    actions: [
      IconButton(
        ...
        icon: Icon(
          icon,
          color: Colors.white60,size: 22.sp,
        ),
      ),
    ],
  );
          ...
          child: isEqualSign
              ? Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: Color.fromARGB(255, 62, 80, 110),
                  ),
                  child: Center(
                    child: Text(
                      label,
                      style: textStyle?.copyWith(color: Color.fromARGB(131, 158, 158, 158)),
                    ),
                  ),
                )
              : Text(
                  ...
                  style: textStyle?.copyWith(
                      color: isColored ? Color.fromARGB(255, 62, 80, 110) : Colors.black),
                ),
        ),
      ),
    );
